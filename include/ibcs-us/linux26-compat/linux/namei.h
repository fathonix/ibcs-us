 ...
 * This file does what the Linux 2.6.32 include file <linux/namei.h>
 ...
 */
#ifndef _IBCS_US_LINUX26_INCLUDE_LINUX_NAMEI_H
#define _IBCS_US_LINUX26_INCLUDE_LINUX_NAMEI_H
#include <sys/cdefs.h>

#include <ibcs-us/linux26-compat/linux/path.h>

extern int user_path(const char* filename, struct path* path);
