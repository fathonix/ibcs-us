 ...
 */
#ifndef _IBCS_US_SVR4_SOCKIO_H
#define _IBCS_US_SVR4_SOCKIO_H

//#ident "%W% %G%"

#include <ibcs-us/per-svr4/types.h>	/* for "svr4_caddr_t" et al */

#include <ibcs-us/linux26-compat/linux/socket.h> /* for "struct sockaddr" et al  */
...
/* socket.c */
extern int abi_do_setsockopt(unsigned int *sp);
extern int abi_do_getsockopt(unsigned int *sp);
